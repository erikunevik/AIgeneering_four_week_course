...
####  This job is for a **Data Engineer with an interest in Analytics Engineering** at **Instabee** in **Stockholm**, working in a hybrid model (3 days in the office).

**Instabee** is a fast-growing European last-mile delivery company formed by the merger of Budbee and Instabox, aiming to revolutionize logistics.

You will join a **newly formed Data Platform team** that uses a modern data stack including FiveTran, Python, DBT, GCP, Snowflake, and Tableau.

**Key Responsibilities:**
*   Shape Instabee's data platform, serving BI, data science, and product teams.
*   **As a Data Engineer:** Lead and build data integration patterns, migrate source integrations (APIs, MongoDB, MySQL), set up/maintain data platform infrastructure, and introduce data product principles.
*   **With Analytics Engineering interest:** Design and build data models supporting business processes, ensuring data governance and trust, and contribute to analytical projects using DBT, SQL, and Python.

**Required Experience & Skills:**
*   Experience in both Data Engineering and Analytics Engineering.
*   Building modern data platforms (GCP, Snowflake).
*   Creating and implementing data platform design patterns.
*   CI/CD pipelines and Infrastructure as Code (IaC).
*   Data orchestration (Airflow or similar).
*   Data modeling with DBT and SQL, programming with Python (or Java/Go).
*   A university degree in a technical or analytical field.
*   Strong collaboration, communication, and visualization skills.
*   Agile mindset, driven to learn and stay updated.

**Bonus Points for:** Docker, Kubernetes, and streaming data experience.

**What they offer:**
*   An impactful role in a rapidly growing company.
*   A modern tech stack and innovative environment.
*   Perks include a sky-high modern office, puppy-friendly policy, tech breakfasts/demos, games, flexible hybrid work, 6 months parental pay, and a day off for your birthday.
