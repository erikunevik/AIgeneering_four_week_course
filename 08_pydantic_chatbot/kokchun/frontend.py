...
# Hanterar users oc assistants input och lägger till dem i state.messages, if för bara när någon skrivit något. 
def handle_user_input():
    ...
    if prompt := st.chat_input("Talk to the JokeBot"):
        ...
        with st.chat_message("user"): #Använarens text
            st.markdown(prompt)
        with st.chat_message("assistant"): #robotens svar
